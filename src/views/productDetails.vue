      ...
      <b-row>
        <b-col>
          ...
          <span v-for="img in productItem[0].image" :key="img.image" style="padding:10px;">
            <b-img :src="img" fluid alt="Responsive image" style="width:50px; height: 50px"></b-img>
          </span>
          <hr />
        </b-col>
        <b-col cols="6">
    ...
    return {
      ...
      products: [
...

        {
          ...
          price: "350,000",
          detail:
            "It is powered by a Core i5 processor and it comes with 12GB of RAM. The Apple MacBook Pro packs 512GB of SSD storage. Connectivity options include Wi-Fi 802.11 ac, Bluetooth and it comes with 2 USB ports (2 x USB 3.0), Mic In ports.",
